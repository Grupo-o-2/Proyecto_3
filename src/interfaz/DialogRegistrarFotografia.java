...
public class DialogRegistrarFotografia extends JDialog implements ActionListener{
	...
	public static void main(String[] args) {
		try {
			...
			DialogRegistrarFotografia dialog = new DialogRegistrarFotografia(registros);
	 ...
	 * Create the dialog.
	 */
	public DialogRegistrarFotografia(RegistroPiezasAdmin frameP) {
		...
		}
		{
			...
			txtAlto.setToolTipText("Alto de la fotografía (Ej: 55)");
			txtAlto.setText("Ingrese el alto de la fotografía");
		...
		}
		{
			...
			txtAncho.setToolTipText("Ancho de la fotografía (Ej: 63)");
			txtAncho.setText("Ingrese el ancho de la fotografía");
		...
		}
		{
			...
			txtFormato.setToolTipText("Formato de la fotografía (Ej: \"png\")");
			txtFormato.setText("Ingrese el formato de la fotografía");
			...
			txtFormato.setBounds(41, 154, 268, 29);
