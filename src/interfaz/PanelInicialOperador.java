...
public class PanelInicialOperador extends JFrame implements ActionListener {
	...
	public PanelInicialOperador() {
		...
		panel_1.setBackground(new Color(219, 58, 52));
		panel_1.setBounds(0, 0, 252, 561);
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JButton cerrarSesion = new JButton("Cerrar sesión");
		cerrarSesion.setForeground(new Color(219, 58, 52));
		...
		btnCompraPieza.setBackground(new Color(219, 58, 52));
		...
		btnConsignarPieza.setBackground(new Color(219, 58, 52));
		...
		btnConsultas.setBackground(new Color(219, 58, 52));
		...
		btnParticiparSubasta.setBackground(new Color(219, 58, 52));
		...
		btnSolAumento.setBackground(new Color(219, 58, 52));
		...
		btnVerHistoriales.setBackground(new Color(219, 58, 52));
		...
		for (Pieza pieza: galeriaInicio.getPiezasActuales()) {
			...
			nueva.setBorder(new LineBorder(new Color(219, 58, 52)));
			panel_3.add(nueva);
		}
	}
