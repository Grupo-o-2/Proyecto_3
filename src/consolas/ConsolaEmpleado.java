...
public class ConsolaEmpleado extends Consola{
	...
	public static void mostrarMenu(){
		...
		System.out.println("1: Ver la historia de un artista.\n");
		System.out.println("2: Ver la historia de una pieza.\n");
	}
	...
	while (centinela)
	{
		...
		{
			System.out.println("------------------------------------------------------------------------------------------\n");
			System.out.println("Bienvenido a la galería - Esta usando la consola predeterminada de Empleado.\n");
			...
			int verificacion = galeriaInicio.verificacionSesion(usuario, contraseña, TIPO_EMPLEADO);
			if (verificacion == 1) {
				int eleccionDos;
