...
public class Fabrica {
	...
	public Escultura crearEscultura(String titulo, int año, int valor, String lugar, ArrayList<Artista> autores, boolean exhibida,
	...
	public Fotografia crearFotografia(String titulo, int año, int valor, String lugar, ArrayList<Artista> autores, boolean exhibida,
	...
	public Impresion crearImpresion(String titulo, int año, int valor, String lugar, ArrayList<Artista> autores, boolean exhibida,
	...
	public Pintura crearPintura(String titulo, int año, int valor, String lugar, ArrayList<Artista> autores, boolean exhibida,
			Comprador creador, String exhibaVendaoSubasta, int ancho, int alto, boolean consignacion,  String fecha, boolean dispsubasta, boolean dispventa) {
	...
	public Video crearVideo(String titulo, int año, int valor, String lugar, ArrayList<Artista> autores, boolean exhibida,
